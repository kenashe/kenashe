...
- `public/images/ken-ashe-2026.jpeg` (dark polo, 1122×1402) is the **current** headshot and
  ...
  its URL must keep working. The Newsroom media kit offers the current headshot, its square
  crop, the SVG logo, and `og-default.png`; nothing else. Portrait files are not Digest artwork: the 1200×800 rule
