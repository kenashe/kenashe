...
This is a PILLAR: the definitive current-state reference on this topic for The Lab, not a reaction to one day's news. Map where the topic actually stands: what is settled, what is contested, what a practitioner should do right now, and what to watch next. Answer the sub-questions a serious reader (or an AI assistant answering them) would expect, each as its own H2. Write the piece you would send someone who says "catch me up on this," and add a forward-looking judgment they could not get from any single source.
