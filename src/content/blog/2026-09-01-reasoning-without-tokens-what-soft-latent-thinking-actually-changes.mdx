...
draft: false
image:
  src: ../../assets/blog/2026-09-01-reasoning-without-tokens-what-soft-latent-thinking-actually-changes/hero.webp
...
![a wide continuous stream being squeezed through a narrow gate into a single dot, repeated in a chain](../../assets/blog/2026-09-01-reasoning-without-tokens-what-soft-latent-thinking-actually-changes/inline-1.webp)
...
![two parallel paths from start to finish, one made of discrete blocks, one a smooth unbroken line](../../assets/blog/2026-09-01-reasoning-without-tokens-what-soft-latent-thinking-actually-changes/inline-2.webp)
...
![a large heavy gear at the end of a loop being lifted out, leaving a lighter loop spinning faster](../../assets/blog/2026-09-01-reasoning-without-tokens-what-soft-latent-thinking-actually-changes/inline-3.webp)
