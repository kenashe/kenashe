...
draft: false
image:
  src: ../../assets/blog/2026-09-07-when-you-upgrade-the-model-does-the-agents-memory-come-with-it/hero.webp
...
![the same block of stored knowledge passing through two differently shaped lenses, one rigid grid and one soft blur, prod](../../assets/blog/2026-09-07-when-you-upgrade-the-model-does-the-agents-memory-come-with-it/inline-1.webp)
...
![two leaking pipes side by side, one losing water at the intake funnel and one losing it at the outlet valve](../../assets/blog/2026-09-07-when-you-upgrade-the-model-does-the-agents-memory-come-with-it/inline-2.webp)
