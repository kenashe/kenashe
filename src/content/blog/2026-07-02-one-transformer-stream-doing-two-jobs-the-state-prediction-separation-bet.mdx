...
draft: true
image:
  src: ../../assets/blog/2026-07-02-one-transformer-stream-doing-two-jobs-the-state-prediction-separation-bet/hero.webp
...
![a single braided rope being pulled in two directions, next to two separate ropes each pulled cleanly in one direction](../../assets/blog/2026-07-02-one-transformer-stream-doing-two-jobs-the-state-prediction-separation-bet/inline-1.webp)
...
![two parallel channels flowing side by side, one channel carrying a sharp focused point of light, the other carrying a sl](../../assets/blog/2026-07-02-one-transformer-stream-doing-two-jobs-the-state-prediction-separation-bet/inline-2.webp)
