...
draft: false
image:
  src: ../../assets/blog/2026-07-02-theoria-makes-a-model-show-its-work-then-checks-every-line/hero.webp
...
![a chain of linked shapes where one link quietly changes color with no thread connecting it to the others, while every ot](../../assets/blog/2026-07-02-theoria-makes-a-model-show-its-work-then-checks-every-line/inline-1.webp)
...
![two funnels side by side, one letting a specific shape of debris pass through while a second funnel with a fine mesh cat](../../assets/blog/2026-07-02-theoria-makes-a-model-show-its-work-then-checks-every-line/inline-2.webp)
...
![a completed path split into visible segments, with a single segment highlighted and pulled slightly away from the rest a](../../assets/blog/2026-07-02-theoria-makes-a-model-show-its-work-then-checks-every-line/inline-3.webp)
