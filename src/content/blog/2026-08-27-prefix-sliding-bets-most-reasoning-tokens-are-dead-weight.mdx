...
draft: false
image:
  src: ../../assets/blog/2026-08-27-prefix-sliding-bets-most-reasoning-tokens-are-dead-weight/hero.webp
...
![a long ribbon where both ends stay solid and bright while the vast middle section fades out and dissolves](../../assets/blog/2026-08-27-prefix-sliding-bets-most-reasoning-tokens-are-dead-weight/inline-1.webp)
...
![two paths climbing a slope, one dragging a growing heavy tail behind it, the other moving light and fast with a fixed sm](../../assets/blog/2026-08-27-prefix-sliding-bets-most-reasoning-tokens-are-dead-weight/inline-2.webp)
...
![a chain of small connected task blocks where only the first block and the last handful stay in focus while the long cent](../../assets/blog/2026-08-27-prefix-sliding-bets-most-reasoning-tokens-are-dead-weight/inline-3.webp)
