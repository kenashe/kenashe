...
draft: false
image:
  src: ../../assets/blog/2026-08-28-what-a-moral-probe-finds-inside-an-llm-structure-not-a-single-switch/hero.webp
...
![six distinct arrows fanning out from a shared center point, none overlapping but all leaning slightly the same way](../../assets/blog/2026-08-28-what-a-moral-probe-finds-inside-an-llm-structure-not-a-single-switch/inline-1.webp)
...
![two proposed groupings of the same set of points, one clean split into two clusters crossed out, the other a looser web ](../../assets/blog/2026-08-28-what-a-moral-probe-finds-inside-an-llm-structure-not-a-single-switch/inline-2.webp)
