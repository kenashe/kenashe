...
draft: true
image:
  src: ../../assets/blog/2026-09-14-running-async-grpo-with-lora-on-hugging-face-jobs-no-nccl-required/hero.png
...
![two separate machines exchanging small parcels through a central shared container, versus two machines wired directly to](../../assets/blog/2026-09-14-running-async-grpo-with-lora-on-hugging-face-jobs-no-nccl-required/inline-1.png)
...
![a single overloaded worker splitting into two independent workers who hand off to each other at their own pace](../../assets/blog/2026-09-14-running-async-grpo-with-lora-on-hugging-face-jobs-no-nccl-required/inline-2.png)
...
![a reusable blueprint being copied onto three different sized building sites](../../assets/blog/2026-09-14-running-async-grpo-with-lora-on-hugging-face-jobs-no-nccl-required/inline-3.png)
