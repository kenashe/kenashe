...
draft: false
image:
  src: ../../assets/blog/2026-07-30-the-office-task-benchmark-that-prices-agents-against-human-labor/hero.webp
...
![a single task splitting into two parallel measurement paths, one representing time and one representing money, both conv](../../assets/blog/2026-07-30-the-office-task-benchmark-that-prices-agents-against-human-labor/inline-1.webp)
...
![a fast lightweight arrow racing far ahead of a slow heavy figure, but the slow figure carrying a noticeably taller stack](../../assets/blog/2026-07-30-the-office-task-benchmark-that-prices-agents-against-human-labor/inline-2.webp)
