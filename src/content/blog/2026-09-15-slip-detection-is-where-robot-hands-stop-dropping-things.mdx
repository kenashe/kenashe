...
draft: false
image:
  src: ../../assets/blog/2026-09-15-slip-detection-is-where-robot-hands-stop-dropping-things/hero.png
...
![a hand closing on an object contrasted with the same hand feeling the object begin to slide, two moments side by side](../../assets/blog/2026-09-15-slip-detection-is-where-robot-hands-stop-dropping-things/inline-1.png)
...
![two sensor streams, one a coarse pressure grid and one a fast vibration trace, merging into a single decision](../../assets/blog/2026-09-15-slip-detection-is-where-robot-hands-stop-dropping-things/inline-2.png)
...
![a layered stack from cheap sensor at the bottom to skill composition to whole-body motion at the top, with a reflex arc ](../../assets/blog/2026-09-15-slip-detection-is-where-robot-hands-stop-dropping-things/inline-3.png)
