...
draft: false
image:
  src: ../../assets/blog/2026-08-05-what-test-time-scaling-actually-means-when-you-read-a-benchmark/hero.webp
...
![a single branching tree explored three different ways: one straight path down, many full paths to the bottom edge, and a](../../assets/blog/2026-08-05-what-test-time-scaling-actually-means-when-you-read-a-benchmark/inline-1.webp)
...
![two paths reaching the same height, one thin and short, one wide and sprawling, suggesting equal results at very differe](../../assets/blog/2026-08-05-what-test-time-scaling-actually-means-when-you-read-a-benchmark/inline-2.webp)
