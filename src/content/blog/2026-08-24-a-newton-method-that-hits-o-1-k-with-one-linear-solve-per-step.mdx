...
draft: false
image:
  src: ../../assets/blog/2026-08-24-a-newton-method-that-hits-o-1-k-with-one-linear-solve-per-step/hero.webp
...
![a ball rolling down a curved valley, with a smooth fast path and a jagged slow path converging on the same low point](../../assets/blog/2026-08-24-a-newton-method-that-hits-o-1-k-with-one-linear-solve-per-step/inline-1.webp)
...
![a dense filled square contrasted with a thin single arrow, representing full matrix versus matrix-vector product](../../assets/blog/2026-08-24-a-newton-method-that-hits-o-1-k-with-one-linear-solve-per-step/inline-2.webp)
...
![three separate landscapes flowing into one shared summit, representing generalization to multiple problem geometries](../../assets/blog/2026-08-24-a-newton-method-that-hits-o-1-k-with-one-linear-solve-per-step/inline-3.webp)
