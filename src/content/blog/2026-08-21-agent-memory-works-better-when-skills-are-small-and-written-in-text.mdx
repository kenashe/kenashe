...
draft: false
image:
  src: ../../assets/blog/2026-08-21-agent-memory-works-better-when-skills-are-small-and-written-in-text/hero.webp
...
![small reusable puzzle pieces flowing into different task-shaped containers while one large rigid block fails to fit](../../assets/blog/2026-08-21-agent-memory-works-better-when-skills-are-small-and-written-in-text/inline-1.webp)
