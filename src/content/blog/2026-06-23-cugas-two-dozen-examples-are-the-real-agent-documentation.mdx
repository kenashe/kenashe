...
draft: false
image:
  src: ../../assets/blog/2026-06-23-cugas-two-dozen-examples-are-the-real-agent-documentation/hero.webp
...
![diagram showing the difference between a single quickstart example fanning into API docs versus a library of two dozen t](../../assets/blog/2026-06-23-cugas-two-dozen-examples-are-the-real-agent-documentation/inline-1.webp)
...
![chart comparing heavyweight all-in-one agent frameworks versus a lightweight harness on axes of control versus built-in ](../../assets/blog/2026-06-23-cugas-two-dozen-examples-are-the-real-agent-documentation/inline-2.webp)
...
![flow diagram of a single agent run from user instruction through tool call, error, retry, and final output](../../assets/blog/2026-06-23-cugas-two-dozen-examples-are-the-real-agent-documentation/inline-3.webp)
