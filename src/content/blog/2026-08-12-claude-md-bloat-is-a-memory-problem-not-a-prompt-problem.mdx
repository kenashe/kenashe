...
draft: false
image:
  src: ../../assets/blog/2026-08-12-claude-md-bloat-is-a-memory-problem-not-a-prompt-problem/hero.webp
...
![a cluttered instruction scroll splitting into two paths, one path accumulating tangled sticky notes and the other path s](../../assets/blog/2026-08-12-claude-md-bloat-is-a-memory-problem-not-a-prompt-problem/inline-1.webp)
