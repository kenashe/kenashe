...
draft: false
image:
  src: ../../assets/blog/2026-07-26-tiny-llms-on-8-microcontrollers-are-an-edge-pattern-not-a-chatbot-story/hero.webp
...
![tiny chip handling a small stream locally while a larger distant system receives only selected signals](../../assets/blog/2026-07-26-tiny-llms-on-8-microcontrollers-are-an-edge-pattern-not-a-chatbot-story/inline-1.webp)
