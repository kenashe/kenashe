...
draft: false
image:
  src: ../../assets/blog/2026-09-16-teaching-models-to-say-i-dont-know-with-a-prompt-not-a-retrain/hero.webp
...
![a single path splitting into two at a gate, one route continuing forward and one curving away](../../assets/blog/2026-09-16-teaching-models-to-say-i-dont-know-with-a-prompt-not-a-retrain/inline-1.webp)
...
![a set of scales weighing a wrong confident answer against a handoff to a human](../../assets/blog/2026-09-16-teaching-models-to-say-i-dont-know-with-a-prompt-not-a-retrain/inline-2.webp)
