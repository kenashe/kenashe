...
draft: false
image:
  src: ../../assets/blog/2026-07-07-the-coordinate-problem-hiding-inside-discrete-diffusion-models/hero.webp
...
![a single sculptural form casting three different shadows on three walls, each shadow a distinct recognizable shape](../../assets/blog/2026-07-07-the-coordinate-problem-hiding-inside-discrete-diffusion-models/inline-1.webp)
...
![two paths starting from the same point, one curving smoothly to a target, the other shooting off toward infinity near th](../../assets/blog/2026-07-07-the-coordinate-problem-hiding-inside-discrete-diffusion-models/inline-2.webp)
...
![a tangle of separate threads on the left resolving into a single clean braided rope on the right](../../assets/blog/2026-07-07-the-coordinate-problem-hiding-inside-discrete-diffusion-models/inline-3.webp)
