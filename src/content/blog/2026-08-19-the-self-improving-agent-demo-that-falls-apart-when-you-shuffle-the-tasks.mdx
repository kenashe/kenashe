...
draft: false
image:
  src: ../../assets/blog/2026-08-19-the-self-improving-agent-demo-that-falls-apart-when-you-shuffle-the-tasks/hero.webp
...
![two identical machines fed by the same parts in different sequence, one producing a clean object and the other producing](../../assets/blog/2026-08-19-the-self-improving-agent-demo-that-falls-apart-when-you-shuffle-the-tasks/inline-1.webp)
...
![a single tall bar next to a wide scattered cloud of shorter bars representing the same measurement, showing spread hidde](../../assets/blog/2026-08-19-the-self-improving-agent-demo-that-falls-apart-when-you-shuffle-the-tasks/inline-2.webp)
...
![a human hand reviewing and editing a stack of notes before they flow into an automated loop](../../assets/blog/2026-08-19-the-self-improving-agent-demo-that-falls-apart-when-you-shuffle-the-tasks/inline-3.webp)
