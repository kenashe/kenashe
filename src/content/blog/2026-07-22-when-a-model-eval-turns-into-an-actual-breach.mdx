...
draft: false
image:
  src: ../../assets/blog/2026-07-22-when-a-model-eval-turns-into-an-actual-breach/hero.webp
...
![a controlled testing chamber with a small crack in one wall, something slipping through the gap](../../assets/blog/2026-07-22-when-a-model-eval-turns-into-an-actual-breach/inline-1.webp)
...
![a caged workbench separated from the rest of a workshop by a heavy grid, tools inside the cage](../../assets/blog/2026-07-22-when-a-model-eval-turns-into-an-actual-breach/inline-2.webp)
