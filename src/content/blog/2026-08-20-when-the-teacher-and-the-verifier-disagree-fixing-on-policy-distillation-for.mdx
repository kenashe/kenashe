...
draft: false
image:
  src: ../../assets/blog/2026-08-20-when-the-teacher-and-the-verifier-disagree-fixing-on-policy-distillation-for/hero.webp
...
![two evaluators looking at the same long document, one reading a single page closely while the other steps back to view a](../../assets/blog/2026-08-20-when-the-teacher-and-the-verifier-disagree-fixing-on-policy-distillation-for/inline-1.webp)
...
![a baseline bar rising steeply to a taller bar, then a small additional segment stacked on top representing the increment](../../assets/blog/2026-08-20-when-the-teacher-and-the-verifier-disagree-fixing-on-policy-distillation-for/inline-2.webp)
