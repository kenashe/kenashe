...
draft: false
image:
  src: ../../assets/blog/2026-07-26-inklings-first-real-test-is-not-the-headline-benchmark/hero.webp
...
![two model deployment paths splitting from one model, one path through a hosted router and one path into self-hosted infr](../../assets/blog/2026-07-26-inklings-first-real-test-is-not-the-headline-benchmark/inline-1.webp)
