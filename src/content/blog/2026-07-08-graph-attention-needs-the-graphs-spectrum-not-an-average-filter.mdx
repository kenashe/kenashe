...
draft: false
image:
  src: ../../assets/blog/2026-07-08-graph-attention-needs-the-graphs-spectrum-not-an-average-filter/hero.webp
...
![a varied set of noisy graph structures flowing into one shared blurry filter on one side, contrasted with each graph pas](../../assets/blog/2026-07-08-graph-attention-needs-the-graphs-spectrum-not-an-average-filter/inline-1.webp)
