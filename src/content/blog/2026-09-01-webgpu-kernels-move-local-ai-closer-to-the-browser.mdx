...
draft: false
image:
  src: ../../assets/blog/2026-09-01-webgpu-kernels-move-local-ai-closer-to-the-browser/hero.webp
...
![browser window connected to a local device chip, with many small operation tiles flowing into one model output](../../assets/blog/2026-09-01-webgpu-kernels-move-local-ai-closer-to-the-browser/inline-1.webp)
