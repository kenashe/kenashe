...
draft: false
image:
  src: ../../assets/blog/2026-07-28-entity-matching-needs-architecture-tests-not-bigger-model-reflexes/hero.webp
...
![three different model paths processing messy paired records, with one path comparing records separately, one joining the](../../assets/blog/2026-07-28-entity-matching-needs-architecture-tests-not-bigger-model-reflexes/inline-1.webp)
