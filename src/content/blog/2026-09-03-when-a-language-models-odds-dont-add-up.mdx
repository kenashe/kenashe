...
draft: false
image:
  src: ../../assets/blog/2026-09-03-when-a-language-models-odds-dont-add-up/hero.webp
...
![a set of interlocking bets arranged so every outcome path leads to the same result, suggesting a trap with no escape](../../assets/blog/2026-09-03-when-a-language-models-odds-dont-add-up/inline-1.webp)
...
![two separate dials, one labeled by a bullseye target and one by a balance scale, showing they can move independently](../../assets/blog/2026-09-03-when-a-language-models-odds-dont-add-up/inline-2.webp)
...
![a monitoring gauge sitting inside a development pipeline, feeding a signal back to a checkpoint](../../assets/blog/2026-09-03-when-a-language-models-odds-dont-add-up/inline-3.webp)
