...
draft: false
image:
  src: ../../assets/blog/2026-08-20-the-token-budget-bug-hiding-in-multi-teacher-distillation/hero.webp
...
![several full vessels of different sizes pouring into one shared container, with the smallest vessels barely contributing](../../assets/blog/2026-08-20-the-token-budget-bug-hiding-in-multi-teacher-distillation/inline-1.webp)
...
![three separate dials feeding into a single balance beam, each dial a different mechanism nudging the beam toward level](../../assets/blog/2026-08-20-the-token-budget-bug-hiding-in-multi-teacher-distillation/inline-2.webp)
...
![a single small model containing several balanced compartments of equal size, contrasted against one lopsided compartment](../../assets/blog/2026-08-20-the-token-budget-bug-hiding-in-multi-teacher-distillation/inline-3.webp)
