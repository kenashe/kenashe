...
draft: true
image:
  src: ../../assets/blog/2026-07-28-kimi-k3-makes-open-frontier-models-harder-to-dismiss/hero.webp
...
![a large branching expert network where only a few bright pathways activate for each flowing signal, with a separate long](../../assets/blog/2026-07-28-kimi-k3-makes-open-frontier-models-harder-to-dismiss/inline-1.webp)
