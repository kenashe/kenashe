...
draft: false
image:
  src: ../../assets/blog/2026-06-30-when-playing-it-safe-makes-reward-hacking-worse/hero.webp
...
![two climbers roped to the same anchor, the one pulled tightest against the rock slipping first while the looser one keep](../../assets/blog/2026-06-30-when-playing-it-safe-makes-reward-hacking-worse/inline-1.webp)
...
![a wide scatter of arrows fanning across an open field versus a tight bundle of arrows all driving into a single crack in](../../assets/blog/2026-06-30-when-playing-it-safe-makes-reward-hacking-worse/inline-2.webp)
...
![a dial turned partway between a loose open position and a fully clamped position, the middle position glowing as the bal](../../assets/blog/2026-06-30-when-playing-it-safe-makes-reward-hacking-worse/inline-3.webp)
