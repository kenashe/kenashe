...
draft: false
image:
  src: ../../assets/blog/2026-08-04-when-should-a-robot-overrule-its-own-plan-cowams-answer/hero.webp
...
![a robot arm's default path shown as a solid line, with a tempting alternate path branching off, and a gate structure bet](../../assets/blog/2026-08-04-when-should-a-robot-overrule-its-own-plan-cowams-answer/inline-1.webp)
...
![two side-by-side robot workspaces, one with a clean coordinated handoff, one with arms colliding, separated by a decisio](../../assets/blog/2026-08-04-when-should-a-robot-overrule-its-own-plan-cowams-answer/inline-2.webp)
...
![a layered filter funnel, each layer narrower, with most inputs passing through unchanged and only a few triggering a bra](../../assets/blog/2026-08-04-when-should-a-robot-overrule-its-own-plan-cowams-answer/inline-3.webp)
