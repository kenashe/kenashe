...
draft: false
image:
  src: ../../assets/blog/2026-08-03-the-blind-spot-in-ai-text-detectors-human-writing-an-llm-touched/hero.webp
...
![a single source document branching into four parallel copies, one untouched and three passing through a machine that res](../../assets/blog/2026-08-03-the-blind-spot-in-ai-text-detectors-human-writing-an-llm-touched/inline-1.webp)
...
![two detection gauges side by side, one reading near full on machine-origin text, the other reading near empty on human-o](../../assets/blog/2026-08-03-the-blind-spot-in-ai-text-detectors-human-writing-an-llm-touched/inline-2.webp)
