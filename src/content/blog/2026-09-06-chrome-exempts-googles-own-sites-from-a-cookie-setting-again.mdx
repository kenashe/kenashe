...
draft: true
image:
  src: ../../assets/blog/2026-09-06-chrome-exempts-googles-own-sites-from-a-cookie-setting-again/hero.webp
...
![a single hand adjusting a switch while one door in a row of identical doors stays open](../../assets/blog/2026-09-06-chrome-exempts-googles-own-sites-from-a-cookie-setting-again/inline-1.webp)
...
![two nested boxes where the inner box quietly retains a glowing marble after the outer box is emptied](../../assets/blog/2026-09-06-chrome-exempts-googles-own-sites-from-a-cookie-setting-again/inline-2.webp)
...
![a magnifying glass over a control panel revealing that one indicator light is wired differently from the rest](../../assets/blog/2026-09-06-chrome-exempts-googles-own-sites-from-a-cookie-setting-again/inline-3.webp)
