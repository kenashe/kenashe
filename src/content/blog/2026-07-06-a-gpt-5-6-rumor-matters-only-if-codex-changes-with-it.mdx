...
draft: false
image:
  src: ../../assets/blog/2026-07-06-a-gpt-5-6-rumor-matters-only-if-codex-changes-with-it/hero.webp
...
![an agent moving through a loop of code files, terminal output, tests, and a final merged patch](../../assets/blog/2026-07-06-a-gpt-5-6-rumor-matters-only-if-codex-changes-with-it/inline-1.webp)
