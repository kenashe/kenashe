...
draft: false
image:
  src: ../../assets/blog/2026-07-08-the-semantic-gap-nobody-talks-about-in-knowledge-graph-qa/hero.webp
...
![a question and its answer separated by a chain of stepping stones, where the middle stones are a different color from bo](../../assets/blog/2026-07-08-the-semantic-gap-nobody-talks-about-in-knowledge-graph-qa/inline-1.webp)
...
![two machines connected by a single clean handoff, one machine tracing a path through a web, the other turning that path ](../../assets/blog/2026-07-08-the-semantic-gap-nobody-talks-about-in-knowledge-graph-qa/inline-2.webp)
