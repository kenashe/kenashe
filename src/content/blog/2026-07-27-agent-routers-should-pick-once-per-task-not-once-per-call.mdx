...
draft: false
image:
  src: ../../assets/blog/2026-07-27-agent-routers-should-pick-once-per-task-not-once-per-call/hero.webp
...
![a branching agent workflow where many small steps stay inside one continuous path tied to a single model choice, contras](../../assets/blog/2026-07-27-agent-routers-should-pick-once-per-task-not-once-per-call/inline-1.webp)
