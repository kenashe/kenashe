...
draft: false
image:
  src: ../../assets/blog/2026-08-23-what-claude-codes-quiet-a-b-test-says-about-silent-model-downgrades/hero.webp
...
![two identical-looking doors, one leading to a short shallow path and one to a long deep path, a figure choosing without ](../../assets/blog/2026-08-23-what-claude-codes-quiet-a-b-test-says-about-silent-model-downgrades/inline-1.webp)
...
![a person standing on a floor that is subtly tilting beneath them while they try to balance a stack of blocks](../../assets/blog/2026-08-23-what-claude-codes-quiet-a-b-test-says-about-silent-model-downgrades/inline-2.webp)
...
![a repeating measurement gauge sampling the same object over time, with a faint line showing where the readings start to ](../../assets/blog/2026-08-23-what-claude-codes-quiet-a-b-test-says-about-silent-model-downgrades/inline-3.webp)
