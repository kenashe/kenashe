...
draft: false
image:
  src: ../../assets/blog/2026-07-28-on-policy-distillation-is-becoming-the-default-move-for-agent-training/hero.webp
...
![a single misstep near the start of a long branching path cascading into many diverging wrong paths downstream](../../assets/blog/2026-07-28-on-policy-distillation-is-becoming-the-default-move-for-agent-training/inline-1.webp)
...
![an orchestrator routing individual data chunks down different processing paths, some dropped, some passed through untouc](../../assets/blog/2026-07-28-on-policy-distillation-is-becoming-the-default-move-for-agent-training/inline-2.webp)
...
![three teacher sources merging into one student, one merge clean and aligned, one partial, one colliding and fracturing](../../assets/blog/2026-07-28-on-policy-distillation-is-becoming-the-default-move-for-agent-training/inline-3.webp)
