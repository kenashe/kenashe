...
draft: false
image:
  src: ../../assets/blog/2026-07-06-lerobot-v0-6-0-turns-robot-simulation-into-a-feedback-loop/hero.webp
...
![a closed circular loop of three connected stages, each flowing into the next, one stage shown as a ghostly imagined scen](../../assets/blog/2026-07-06-lerobot-v0-6-0-turns-robot-simulation-into-a-feedback-loop/inline-1.webp)
...
![two mirrored robot arms reaching for the same object, one rendered in clean simplified simulation style and one in messy](../../assets/blog/2026-07-06-lerobot-v0-6-0-turns-robot-simulation-into-a-feedback-loop/inline-2.webp)
