...
draft: false
image:
  src: ../../assets/blog/2026-07-31-computer-use-agents-need-stricter-judges-not-prettier-demos/hero.webp
...
![a desktop agent trail with branching paths, where one path appears complete on the surface while a separate evaluator sp](../../assets/blog/2026-07-31-computer-use-agents-need-stricter-judges-not-prettier-demos/inline-1.webp)
