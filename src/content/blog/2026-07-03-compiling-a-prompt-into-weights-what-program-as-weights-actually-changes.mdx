...
draft: false
image:
  src: ../../assets/blog/2026-07-03-compiling-a-prompt-into-weights-what-program-as-weights-actually-changes/hero.webp
...
![a large ornate machine producing many small identical keys, each key then opening its own door repeatedly without the ma](../../assets/blog/2026-07-03-compiling-a-prompt-into-weights-what-program-as-weights-actually-changes/inline-1.webp)
...
![two cost curves as rising and falling terrain, one climbing steadily forever, the other with a single steep hill then a ](../../assets/blog/2026-07-03-compiling-a-prompt-into-weights-what-program-as-weights-actually-changes/inline-2.webp)
