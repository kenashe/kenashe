...
draft: false
image:
  src: ../../assets/blog/2026-08-29-when-llm-memory-becomes-program-analysis/hero.webp
...
![an AI agent observing a codebase through multiple lenses, with files, tests, runtime traces, and prior edits converging ](../../assets/blog/2026-08-29-when-llm-memory-becomes-program-analysis/inline-1.webp)
