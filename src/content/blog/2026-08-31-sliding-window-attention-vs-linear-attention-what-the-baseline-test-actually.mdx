...
draft: false
image:
  src: ../../assets/blog/2026-08-31-sliding-window-attention-vs-linear-attention-what-the-baseline-test-actually/hero.webp
...
![two ways of pruning a long chain of connected nodes, one keeping only a recent cluster plus a fixed anchor at the start,](../../assets/blog/2026-08-31-sliding-window-attention-vs-linear-attention-what-the-baseline-test-actually/inline-1.webp)
...
![a simple bar-style contrast between two approaches on a reasoning task, one clearly taller, drawn as abstract stacked bl](../../assets/blog/2026-08-31-sliding-window-attention-vs-linear-attention-what-the-baseline-test-actually/inline-2.webp)
...
![a comparison table with one previously empty column now filled in, changing which row looks best, shown abstractly as a ](../../assets/blog/2026-08-31-sliding-window-attention-vs-linear-attention-what-the-baseline-test-actually/inline-3.webp)
