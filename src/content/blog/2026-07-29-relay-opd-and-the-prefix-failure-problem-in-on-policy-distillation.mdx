...
draft: false
image:
  src: ../../assets/blog/2026-07-29-relay-opd-and-the-prefix-failure-problem-in-on-policy-distillation/hero.webp
...
![a single path branching wrong near its start, with a long doomed stretch trailing off, versus a short correction near th](../../assets/blog/2026-07-29-relay-opd-and-the-prefix-failure-problem-in-on-policy-distillation/inline-1.webp)
...
![two runners on the same track diverging sharply at one point, one veering off, one turning back](../../assets/blog/2026-07-29-relay-opd-and-the-prefix-failure-problem-in-on-policy-distillation/inline-2.webp)
