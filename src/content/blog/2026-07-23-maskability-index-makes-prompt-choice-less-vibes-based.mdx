...
draft: false
image:
  src: ../../assets/blog/2026-07-23-maskability-index-makes-prompt-choice-less-vibes-based/hero.webp
...
![two different prompt shapes entering the same language model, with one path fitting cleanly into the model and the other](../../assets/blog/2026-07-23-maskability-index-makes-prompt-choice-less-vibes-based/inline-1.webp)
