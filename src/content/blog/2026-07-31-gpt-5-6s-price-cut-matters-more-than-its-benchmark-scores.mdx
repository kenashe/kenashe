...
draft: true
image:
  src: ../../assets/blog/2026-07-31-gpt-5-6s-price-cut-matters-more-than-its-benchmark-scores/hero.webp
...
![a single workflow path that stays intact as its cost weight shrinks, versus a forked path that splits toward a smaller, ](../../assets/blog/2026-07-31-gpt-5-6s-price-cut-matters-more-than-its-benchmark-scores/inline-1.webp)
...
![a router directing many small requests to a light lane and a few complex requests to a heavy lane](../../assets/blog/2026-07-31-gpt-5-6s-price-cut-matters-more-than-its-benchmark-scores/inline-2.webp)
...
![a container of usage expanding to fill newly available space, with the total staying roughly the same size](../../assets/blog/2026-07-31-gpt-5-6s-price-cut-matters-more-than-its-benchmark-scores/inline-3.webp)
