...
draft: false
image:
  src: ../../assets/blog/2026-06-25-when-models-quietly-unlearn-the-natural-ungrokking-problem/hero.webp
...
![two rising paths that cross, one continuing up while the other bends downward, against a smooth descending background li](../../assets/blog/2026-06-25-when-models-quietly-unlearn-the-natural-ungrokking-problem/inline-1.webp)
...
![a stream of flowing particles where the denser regions reinforce a structure and the sparser regions let it dissolve](../../assets/blog/2026-06-25-when-models-quietly-unlearn-the-natural-ungrokking-problem/inline-2.webp)
