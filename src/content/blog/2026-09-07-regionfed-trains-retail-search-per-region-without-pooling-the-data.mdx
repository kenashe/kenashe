...
draft: false
image:
  src: ../../assets/blog/2026-09-07-regionfed-trains-retail-search-per-region-without-pooling-the-data/hero.webp
...
![one shared model shape being pulled toward several different regional shapes, tension visible at the connection points](../../assets/blog/2026-09-07-regionfed-trains-retail-search-per-region-without-pooling-the-data/inline-1.webp)
...
![two paths reaching the same summit, one straight over open ground and one fenced and guarded, arriving at nearly the sam](../../assets/blog/2026-09-07-regionfed-trains-retail-search-per-region-without-pooling-the-data/inline-2.webp)
...
![separate walled gardens each keeping their own contents, connected by thin threads carrying abstract signals rather than](../../assets/blog/2026-09-07-regionfed-trains-retail-search-per-region-without-pooling-the-data/inline-3.webp)
