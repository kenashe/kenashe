...
draft: false
image:
  src: ../../assets/blog/2026-08-21-iar-makes-retrieval-free-document-qa-less-brittle/hero.webp
...
![three distinct document streams entering one model, then merging with a separate base model into a single balanced model](../../assets/blog/2026-08-21-iar-makes-retrieval-free-document-qa-less-brittle/inline-1.webp)
