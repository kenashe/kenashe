...
draft: false
image:
  src: ../../assets/blog/2026-08-04-where-multimodal-embeddings-and-collaborative-coding-agents-actually-stand/hero.webp
...
![a single stream splitting into two parallel outputs at the end, one branch dense and continuous, one branch discrete and](../../assets/blog/2026-08-04-where-multimodal-embeddings-and-collaborative-coding-agents-actually-stand/inline-1.webp)
...
![an output distribution being weighed on a balance scale against a target distribution whose base is a floating question ](../../assets/blog/2026-08-04-where-multimodal-embeddings-and-collaborative-coding-agents-actually-stand/inline-2.webp)
...
![an agent following a straight path through code that a second hand quietly rearranges just ahead of it](../../assets/blog/2026-08-04-where-multimodal-embeddings-and-collaborative-coding-agents-actually-stand/inline-3.webp)
