...
draft: false
image:
  src: ../../assets/blog/2026-07-31-when-you-count-the-tokens-self-reflection-loses-to-just-sampling-more/hero.webp
...
![two paths from a question to an answer, one path a single loop that reruns several times feeding a tally, the other path](../../assets/blog/2026-07-31-when-you-count-the-tokens-self-reflection-loses-to-just-sampling-more/inline-1.webp)
...
![two downward trends as model size grows, one line for choosing rising toward break-even, one line for rewriting staying ](../../assets/blog/2026-07-31-when-you-count-the-tokens-self-reflection-loses-to-just-sampling-more/inline-2.webp)
