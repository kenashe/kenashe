...
draft: true
image:
  src: ../../assets/blog/2026-07-01-models-can-learn-to-explain-themselves-from-stale-data/hero.webp
...
![an input flowing into two branches, one unchanged and one altered, producing two different outputs that reveal which par](../../assets/blog/2026-07-01-models-can-learn-to-explain-themselves-from-stale-data/inline-1.webp)
...
![a compass needle staying pointed at a moving target while the original fixed marker drifts away behind it](../../assets/blog/2026-07-01-models-can-learn-to-explain-themselves-from-stale-data/inline-2.webp)
...
![a single reusable key opening several different locks arranged in a row](../../assets/blog/2026-07-01-models-can-learn-to-explain-themselves-from-stale-data/inline-3.webp)
