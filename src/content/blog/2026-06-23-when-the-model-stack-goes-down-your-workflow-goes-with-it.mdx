...
draft: true
image:
  src: ../../assets/blog/2026-06-23-when-the-model-stack-goes-down-your-workflow-goes-with-it/hero.webp
...
![diagram showing many model endpoints sharing one gateway, auth, and routing layer, with a single failure point marked in](../../assets/blog/2026-06-23-when-the-model-stack-goes-down-your-workflow-goes-with-it/inline-1.webp)
...
![flowchart contrasting an untested fallback path versus a regularly-exercised one with a small percentage of shadow traff](../../assets/blog/2026-06-23-when-the-model-stack-goes-down-your-workflow-goes-with-it/inline-2.webp)
