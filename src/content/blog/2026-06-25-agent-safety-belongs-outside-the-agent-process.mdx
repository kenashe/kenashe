...
draft: false
image:
  src: ../../assets/blog/2026-06-25-agent-safety-belongs-outside-the-agent-process/hero.webp
...
![an agent process reaching toward several tools while a separate gate sits between the agent and every tool path, with bl](../../assets/blog/2026-06-25-agent-safety-belongs-outside-the-agent-process/inline-1.webp)
