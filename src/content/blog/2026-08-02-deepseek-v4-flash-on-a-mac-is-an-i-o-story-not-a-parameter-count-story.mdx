...
draft: false
image:
  src: ../../assets/blog/2026-08-02-deepseek-v4-flash-on-a-mac-is-an-i-o-story-not-a-parameter-count-story/hero.webp
...
![small model core staying in memory while different expert blocks stream in from storage and feed a single response path](../../assets/blog/2026-08-02-deepseek-v4-flash-on-a-mac-is-an-i-o-story-not-a-parameter-count-story/inline-1.webp)
