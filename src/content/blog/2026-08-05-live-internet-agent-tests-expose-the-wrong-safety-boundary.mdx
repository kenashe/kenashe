...
draft: true
image:
  src: ../../assets/blog/2026-08-05-live-internet-agent-tests-expose-the-wrong-safety-boundary/hero.webp
...
![a contained model inside a sandbox reaching toward several external tools, with one path blocked and one path leading to](../../assets/blog/2026-08-05-live-internet-agent-tests-expose-the-wrong-safety-boundary/inline-1.webp)
