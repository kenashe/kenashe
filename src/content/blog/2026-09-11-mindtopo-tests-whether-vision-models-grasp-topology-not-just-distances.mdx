...
draft: false
image:
  src: ../../assets/blog/2026-09-11-mindtopo-tests-whether-vision-models-grasp-topology-not-just-distances/hero.webp
...
![a single loop of string, one version lying flat and one version stretched into a different shape, shown as clearly the s](../../assets/blog/2026-09-11-mindtopo-tests-whether-vision-models-grasp-topology-not-just-distances/inline-1.webp)
...
![a clear single-step recognition on one side and a branching multi-step path where each step depends on the last on the o](../../assets/blog/2026-09-11-mindtopo-tests-whether-vision-models-grasp-topology-not-just-distances/inline-2.webp)
...
![a sequence of frames that each look convincing on their own but where a closed loop quietly becomes an open one across t](../../assets/blog/2026-09-11-mindtopo-tests-whether-vision-models-grasp-topology-not-just-distances/inline-3.webp)
